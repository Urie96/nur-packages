...
scripts/context7-cli search nextjs "middleware"
...
scripts/context7-cli docs /vercel/next.js "middleware matcher config"

# Pin version (only ones listed in search output work)
scripts/context7-cli docs /vercel/next.js/v15.1.8 "app router migration"
```
